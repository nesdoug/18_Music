...
;
	jmp     L060E
L07F6:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L060E:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L07FB:	lda     #$00
L07F3:	sta     _map_loaded
;
; temp5 = BoxGuy1.x;
;
L0684:	lda     _BoxGuy1+1
	sta     _temp5+1
	lda     _BoxGuy1
	sta     _temp5
;
...
;
L0742:	ldy     _coordinates
	lda     _c_map2,y
L080E:	sta     _collision
;
