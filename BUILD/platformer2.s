...
;
	...
	sec
	sbc     _eject_R
L07B7:	sta     _BoxGuy1+1
;
; if(BoxGuy1.vel_y < 0x300){
;
L0623:	lda     _BoxGuy1+6
	cmp     #$00
	lda     _BoxGuy1+6+1
	sbc     #$03
	bvc     L062D
...
;
L06DD:	ldy     _coordinates
	lda     _c_map2,y
L07CE:	sta     _collision
;
