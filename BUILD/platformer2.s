...
;
	...
	sec
	sbc     _eject_R
L07BA:	sta     _BoxGuy1+1
;
; if(BoxGuy1.vel_y < 0x300){
;
L0628:	lda     _BoxGuy1+6
	cmp     #$00
	lda     _BoxGuy1+6+1
	sbc     #$03
	bvc     L0632
